...
export const projects: Project[] = [
  {
    ...
    solution: `팀원들과의 적극적 의사소통과 명확한 역할 분담을 통해 효율적인 개발 일정을 관리했습니다.
  ...
  },
  {
    ...
    challenge:
      '이 프로젝트에서 처음으로 PL로서 기술적인 리더십을 발휘하고, 팀원들과의 효율적인 협업 프로세스를 구축하는 것이 도전 과제였습니다.',
    solution:
  ...
  },
  {
    ...
    solution:
      '공식 문서를 통해 지도 기능을 성공적으로 구현했으며, 기존 학습 경험(DUC 프로젝트)을 적극 활용하고 핵심 기능 구현에 집중하여 백엔드까지 빠르게 구현할 수 있었습니다.',
    result:
