      ...
      <div className="container mx-auto px-4 md:px-5">
        ...
        >
          {skils.map((skilGroup, index) => (
            <div
              key={index}
              className={`${isVisible ? 'animate-fadeUp6B' : 'opacity-0'} border-border dark:hover:shadow-shadow rounded-lg border p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:hover:shadow-lg`}
