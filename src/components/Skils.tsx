      ...
      <div className="container mx-auto px-4 md:px-5">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {skils.map((skilGroup, index) => (
            <div
              key={index}
              className={`${isVisible ? 'animate-fadeUp6B' : 'opacity-0'} border-muted rounded-lg border p-6 shadow-sm transition-opacity hover:shadow-md`}
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="mb-6 flex items-center gap-3">
                <div className="bg-foreground/10 text-foreground rounded-md p-2">
                  {skilGroup.icon}
                </div>
